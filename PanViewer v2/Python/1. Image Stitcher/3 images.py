...
# Test implementation
imageA = cv2.imread('left.jpg', 1)
imageB = cv2.imread('middle.jpg', 1)
imageC = cv2.imread('right.jpg', 1)
imageA = imutils.resize(imageA, width=400)
imageB = imutils.resize(imageB, width=400)
imageC = imutils.resize(imageC, width=400)

(result, vis) = stitch(imageC, imageB, showMatches=True)
(final, vis) = stitch(result, imageA, showMatches=True)
