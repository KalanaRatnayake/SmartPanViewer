...
>>>>>>> 1e0ec35262f51a5cffe8d09a454125d65c576e29
    time.sleep(1)
...
def getHomographyMatrix(frameA, frameB):
    ...
    return H
# ==============================================================================
#calibration function to call in certain intervals

def calibrateCam(strm1,strm2):
    print "c"
    global HomMat
       
    # take initial images to calibrate
    retA, frameA = strm1.read()
    cv2.imshow('A', frameA)

    retB, frameB = strm2.read()
    cv2.imshow('B', frameB)

    HomMat = getHomographyMatrix(frameA, frameB)
    print HomMat
  
        

# ==============================================================================   
#camera thread to avoid recurrance
def threadedCams():
    calibrateCam(cap1,cap2)
    
    #calibrateCam function is calling in a thread
    threading.Timer(1, calibrateCam, [cap1,cap2]).start()
    print "t"
